...
function getMediatedTokens(): TypedMap<Address, Address> {
  ...
  mediatedTokens.set(
    // BSC Test net
    Address.fromString('0x5137f6a5a78566582D31329B94285950CaA3Cd55'),
    Address.fromString('0xa0afea6b778fc06669f56dd9fa3163cebe18f648'),
  );

  // log.debug('bsc test net address {}', [Address.fromString('0x5137f6a5a78566582D31329B94285950CaA3Cd55').toHexString()])
